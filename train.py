...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train RSIC.")
    parser.add_argument(
        "--quality-profile",
    ...
    parser.add_argument(
        "--decoder-type",
        choices=("standard", "cheng2020_attention", "swin"),
        default="swin",
        help="PC-side synthesis transform decoder type.",
    )
...
def apply_quality_profile(args: argparse.Namespace) -> None:
    ...
    if args.model_variant is None:
        args.model_variant = MODEL_VARIANT_HYPER_MS_Q_NANO
